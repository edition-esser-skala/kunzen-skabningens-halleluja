...
LobUndEhreTenoreNotes = {
	\relative c' {
		\clef "treble_8"
		\key es \major \time 4/4 \autoBeamOff \tempoLobUndEhre
		\mvTr es4.\fE^\tuttiE es8 f4 f8 f
		g4. f8 es4 f8 f
		g4. f8 es4 f8 f
		g4.( f8) es4 r
		es f es d8 d %5
...
LobUndEhreTenoreLyrics = \lyricmode {
	Lob und Eh -- re dem
	E -- wi -- gen! dem All --
	mäch -- ti -- gen! dem All --
	wei -- sen!
...
LobUndEhreTenoreLyricsDansk = \lyricmode {
	Lo -- vet væ -- re den
	E -- vi -- ge! den Al --
	mæg -- ti -- ge! den Al --
	vi -- se!
...
HochInsChorTenoreLyrics = \lyricmode {
	Hoch, ins
	Chor der
	Him -- mels
	Söh -- ne,
...
HochInsChorTenoreLyricsDansk = \lyricmode {
	Høit, i
	Chor af
	Mil -- li --
	o -- ner,
...
% Hal -- le -- lu -- ja! vi e -- re! Hal -- le -- lu -- ja! du er, du var, og du skal væ -- re vor Gud!
