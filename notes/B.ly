...
HeiligBassoNotes = {
  \relative c {
    ...
    b1~
    b~ %25
    << \context Voice = "Basso" { b\fermata } \\ { s2..\< s8\! } >> \bar "||" %26 finis
  }
}
...
HochInsChorBassoNotes = {
  \relative c {
    ...
    es2 r
    R1
    R\fermata \bar "|." %169 FINIS
  }
}

HochInsChorBassoLyrics = \lyricmode {
  Hoch, ins
  Chor der
  Him -- mels
  Söh -- ne,
...
HochInsChorBassoLyricsDansk = \lyricmode {
  Høit, i
  Chor af
  Mil -- li --
  o -- ner,
